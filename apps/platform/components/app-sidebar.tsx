...
import { Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupContent, SidebarHeader, SidebarInput, SidebarMenu, SidebarMenuButton, SidebarMenuItem, useSidebar } from "@workspace/ui/components/sidebar";
      ...
      <Sidebar collapsible="none" className="hidden flex-1 md:flex">
        ...
        <SidebarContent>
          <SidebarGroup className="px-0">
            <SidebarGroupContent>{/* TODO: This is where workflows will be displayed */}</SidebarGroupContent>
          </SidebarGroup>
        </SidebarContent>
      </Sidebar>
    </Sidebar>
